...
//        setExtendedState(MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 80, 300, 340));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/fff.png"))); // NOI18N
        jLabel5.setText("jLabel5");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 870, 510));

        setSize(new java.awt.Dimension(884, 551));
        ...
        if (username.equals("") || password.equals("")) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(this, "User tidak ditemukan, coba lagi !");
                }
                ps.close();
                ps.close();
